...
I mainly have experience in Python and Java, especially in backend development. I want to learn more about AI platform engineering, backend architecture, and machine learning engineering. I also want to learn SQL, since I don't have much experience with it. 

I use a Macbook Air (M1, 2020), running on macOS Tahoe 26.5.2. 
